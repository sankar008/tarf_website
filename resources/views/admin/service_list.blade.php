...
<div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">{{ __("Service List") }}</h4>
        <div class="card">
            <div class="tab-content">
                <div class="row">
                    <div class="col-md-12">                        
                        <div class="align-items-center d-flex justify-content-between">
                            <h5 class="card-header px-0">{{ __("Service List") }}</h5>
                            <a href="#">Add</a>
                        </div>
                    </div>          
                ...
                <div class="text-nowrap table-responsive">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            <td>{{ ++$loop -> index }}</td>
                            <td><img src={{ asset($data -> title) }} width="30" height="40"/></td>
                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $data -> details }}</strong></td>
                            <td>
