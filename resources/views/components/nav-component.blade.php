          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('company.list') }}" class="menu-link">
                ...
                <div data-i18n="Analytics">Company details</div>
              </a>
            </li>

            <li class="menu-item">
              <a href="{{ route('aboutus.list') }}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="{{ route('whyus.list') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
                <div data-i18n="Analytics">Why us</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="{{ route('slider.update') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
