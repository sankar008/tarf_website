            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title text-color-white" data-aos="fade-right" data-aos-duration="3000">Why Us</h1>                      
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="{{ asset($data -> image_1) }}" alt="About Us Image" data-aos="fade-up" data-aos-duration="3000">
